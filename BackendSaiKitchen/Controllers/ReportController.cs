...
namespace BackendSaiKitchen.Controllers
{
    public class ReportController : BaseController
    {
        ...
        {
            Models.Customer customer = customerRepository
                .FindByCondition(x => x.IsActive == true && x.IsDeleted == false && x.CustomerId == CustomerId)
            ...
            if (customer != null)
            {
                Report report = customerRepository.FindByCondition(x =>
                        x.IsActive == true && x.IsDeleted == false && x.CustomerId == CustomerId)
                    .Select(x => new Report
                    {
                        CustomerId = x.CustomerId,
                        CustomerName = x.CustomerName,
                        TotalInquiries = x.Inquiries.Where(x => x.IsActive == true && x.IsDeleted == false).Count(),
                        Totalquotations = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Quotations.Where(y => y.IsActive == true && y.IsDeleted == false).Count(),
                        TotalJoborder = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .JobOrders.Where(y => y.IsActive == true && y.IsDeleted == false).Count(),
                        QuotationAccepted = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Quotations.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.QuotationStatusId == (int)inquiryStatus.quotationAccepted).Count(),
                        QuotationRejected = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Quotations.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.QuotationStatusId == (int)inquiryStatus.quotationRejected).Count(),
                        QuotationPending = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Quotations.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.QuotationStatusId == (int)inquiryStatus.quotationRejected).Count(),
                        Payments = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments
                            .Where(y => y.IsActive == true && y.IsDeleted == false &&
                                        (y.PaymentStatusId != (int)paymentstatus.InstallmentCreated ||
                                         y.PaymentStatusId != (int)paymentstatus.PaymentCreated)).Count(),
                        TotalAmount = (decimal)x.Inquiries
                            .FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                (y.PaymentStatusId != (int)paymentstatus.InstallmentCreated ||
                                 y.PaymentStatusId != (int)paymentstatus.PaymentCreated) && y.PaymentModeId != null)
                            .Sum(y => y.PaymentAmount),
                        TotalUnpaid = (decimal)x.Inquiries
                            .FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentPending ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentPending ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentWaitingofApproval ||
                                 y.PaymentStatusId == (int)paymentstatus.PaymentWaitingofApproval))
                            .Sum(y => y.PaymentAmount),
                        TotalPaid = (decimal)x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                            .Sum(y => y.PaymentAmount),
                        CashPaid = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments
                            .Where(y => y.IsActive == true && y.IsDeleted == false &&
                                        y.PaymentModeId == (int)paymentMode.Cash &&
                                        (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                         y.PaymentStatusId == (int)paymentstatus.InstallmentApproved)).Count(),
                        TotalCash = (decimal)x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.Cash &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                            .Sum(y => y.PaymentAmount),
                        ChequePaid = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.Cheque &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved)).Count(),
                        TotalCheque = (decimal)x.Inquiries
                            .FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.Cheque &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                            .Sum(y => y.PaymentAmount),
                        OnlinePaid = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.OnlinePayment &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved)).Count(),
                        TotalOnline = (decimal)x.Inquiries
                            .FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.OnlinePayment &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                            .Sum(y => y.PaymentAmount),
                        BankPaid = x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false).Payments
                            .Where(y => y.IsActive == true && y.IsDeleted == false &&
                                        y.PaymentModeId == (int)paymentMode.OfflinePaybyCard &&
                                        (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                         y.PaymentStatusId == (int)paymentstatus.InstallmentApproved)).Count(),
                        TotalBank = (decimal)x.Inquiries.FirstOrDefault(x => x.IsActive == true && x.IsDeleted == false)
                            .Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                y.PaymentModeId == (int)paymentMode.OfflinePaybyCard &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentApproved)).Sum(y => y.PaymentAmount)
                    }).FirstOrDefault();

                report.reviews = new List<Review>();
                foreach (Models.Inquiry inquiry in customer.Inquiries)
                {
                    List<CustomerReview> CustomerReview = new List<CustomerReview>();
                    foreach (Models.InquiryWorkscope inworkscope in inquiry.InquiryWorkscopes)
                    {
        ...
        public object GetReportForUser(ReqReport req)
        {
            Models.User user = userRepository
                .FindByCondition(x => x.IsActive == true && x.IsDeleted == false && x.UserId == req.Id).Include(x =>
                    x.InquiryManagedByNavigations.Where(y => y.IsActive == true && y.IsDeleted == false))
            ...
            if (user != null)
            {
                ...
                {
                    if (DateTime.Parse(inquiry.InquiryStartDate) >= DateTime.Parse(req.StartDate) &&
                        DateTime.Parse(inquiry.InquiryStartDate) <= DateTime.Parse(req.EndDate))
                    {
                        List<CustomerReview> CustomerReview = new List<CustomerReview>();
                        foreach (Models.InquiryWorkscope inworkscope in inquiry.InquiryWorkscopes)
                        {
        ...
        public object GetReportForBranch(ReqReport req)
        {
            ...
            Models.Branch branch = branchRepository
                .FindByCondition(x => x.BranchId == req.Id && x.IsActive == true && x.IsDeleted == false)
                .Include(x => x.Inquiries.Where(y => y.IsActive == true && y.IsDeleted == false))
                .ThenInclude(x => x.InquiryWorkscopes.Where(y => y.IsActive == true && y.IsDeleted == false))
            ...
            if (branch != null)
            {
                ...
                if (branch.Inquiries.Count != 0)
                {
                    ...
                    //double? satisfy = 0;
                    //int inWCount = 0;
                    foreach (Models.Inquiry inquiry in branch.Inquiries.Where(y =>
                        y.IsActive == true && y.IsDeleted == false &&
                        Helper.Helper.ConvertToDateTime(y.CreatedDate) >=
                        Helper.Helper.ConvertToDateTime(req.StartDate) &&
                        Helper.Helper.ConvertToDateTime(y.CreatedDate) <= Helper.Helper.ConvertToDateTime(req.EndDate)))
                    {
                        received += (decimal)inquiry.Payments.Where(y =>
                                        y.IsActive == true && y.IsDeleted == false &&
                                        (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                         y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                                    ?.Sum(y => y.PaymentAmount) /
                                    100;
                        pending += (decimal)inquiry.Payments.Where(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                (y.PaymentStatusId == (int)paymentstatus.PaymentPending ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentPending ||
                                 y.PaymentStatusId == (int)paymentstatus.InstallmentWaitingofApproval ||
                                 y.PaymentStatusId == (int)paymentstatus.PaymentWaitingofApproval))
                            ?.Sum(y => y.PaymentAmount) / 100;
                        cashcount += inquiry.Payments.Where(y =>
                            y.IsActive == true && y.IsDeleted == false && y.PaymentModeId == (int)paymentMode.Cash &&
                            (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                             y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))?.Count();
                        bankcount += inquiry.Payments.Where(y =>
                            y.IsActive == true && y.IsDeleted == false &&
                            y.PaymentModeId == (int)paymentMode.OfflinePaybyCard &&
                            (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                             y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))?.Count();
                        chequecount += inquiry.Payments.Where(y =>
                            y.IsActive == true && y.IsDeleted == false && y.PaymentModeId == (int)paymentMode.Cheque &&
                            (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                             y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))?.Count();
                        onlinecount += inquiry.Payments.Where(y =>
                            y.IsActive == true && y.IsDeleted == false &&
                            y.PaymentModeId == (int)paymentMode.OnlinePayment &&
                            (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                             y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))?.Count();
                        banksum += (decimal)inquiry.Payments.Where(y =>
                                       y.IsActive == true && y.IsDeleted == false &&
                                       y.PaymentModeId == (int)paymentMode.OfflinePaybyCard &&
                                       (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                        y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                                   ?.Sum(y => y.PaymentAmount) /
                                   100;
                        cashsum += (decimal)inquiry.Payments.Where(y =>
                                       y.IsActive == true && y.IsDeleted == false &&
                                       y.PaymentModeId == (int)paymentMode.Cash &&
                                       (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                        y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                                   ?.Sum(y => y.PaymentAmount) /
                                   100;
                        chequesum += (decimal)inquiry.Payments.Where(y =>
                                         y.IsActive == true && y.IsDeleted == false &&
                                         y.PaymentModeId == (int)paymentMode.Cheque &&
                                         (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                          y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                                     ?.Sum(y => y.PaymentAmount) /
                                     100;
                        onlinesum += (decimal)inquiry.Payments.Where(y =>
                                         y.IsActive == true && y.IsDeleted == false &&
                                         y.PaymentModeId == (int)paymentMode.OnlinePayment &&
                                         (y.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                          y.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                    ...
                    report = new BranchReport
                    {
                        ...
                        JobOrederRejected = branch?.Inquiries?.Where(x =>
                            ...
                            ?.Count(), //.JobOrders.Where(z => z.IsActive == true && z.IsDeleted == false)?.Count(),
                        QuotationAccepted = branch?.Inquiries
                            ?.FirstOrDefault(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                Helper.Helper.ConvertToDateTime(y.CreatedDate) >=
                                Helper.Helper.ConvertToDateTime(req.StartDate) &&
                                Helper.Helper.ConvertToDateTime(y.CreatedDate) <=
                                Helper.Helper.ConvertToDateTime(req.EndDate))?.Quotations?.Where(x =>
                                x.IsActive == true && x.IsDeleted == false &&
                                x.QuotationStatusId == (int)inquiryStatus.quotationAccepted)?.Count(),
                        QuotationPending = branch?.Inquiries?.Where(y =>
                            y.IsActive == true && y.IsDeleted == false &&
                            Helper.Helper.ConvertToDateTime(y.CreatedDate) >=
                            Helper.Helper.ConvertToDateTime(req.StartDate) &&
                            Helper.Helper.ConvertToDateTime(y.CreatedDate) <=
                            ...
                            (y.InquiryStatusId == (int)inquiryStatus.quotationPending ||
                             y.InquiryStatusId == (int)inquiryStatus.quotationSchedulePending))?.Count(),
                        QuotationRejected = branch?.Inquiries
                            ?.FirstOrDefault(y =>
                                y.IsActive == true && y.IsDeleted == false &&
                                Helper.Helper.ConvertToDateTime(y.CreatedDate) >=
                                Helper.Helper.ConvertToDateTime(req.StartDate) &&
                        ...
                        CustomerSatisfy = (double?)Math.Round((decimal)branch?.Inquiries
                                                                  ...
                                                                  ?.Select(x =>
                                                                      x.FeedbackReaction == null ? 1 :
                                                                      x.FeedbackReaction == 0 ? 1 : x.FeedbackReaction)
                                                                  .Average() * 100 /
                                                              7) // branch?.Inquiries?.FirstOrDefault(y => Helper.Helper.ConvertToDateTime(y.CreatedDate) >= Helper.Helper.ConvertToDateTime(req.StartDate) && Helper.Helper.ConvertToDateTime(y.CreatedDate) <= Helper.Helper.ConvertToDateTime(req.EndDate))?.InquiryWorkscopes ?.Select(x => x.FeedbackReaction).Count()*100
                    };
                }
                ...
                foreach (Models.Inquiry inquiry in branch.Inquiries.Where(y =>
                    Helper.Helper.ConvertToDateTime(y.CreatedDate) >= Helper.Helper.ConvertToDateTime(req.StartDate) &&
                    Helper.Helper.ConvertToDateTime(y.CreatedDate) <= Helper.Helper.ConvertToDateTime(req.EndDate)))
                {
                    if (inquiry.Payments
                            .Where(x => x.PaymentStatusId == (int)paymentstatus.InstallmentPending ||
                                        x.PaymentStatusId == (int)paymentstatus.PaymentPending)
                        ...
                        100 > 0)
                    {
                        report.inquiryPendingDetails.Add(new InquiryPendingDetails
                        {
                            ...
                            WorkscopeName = inquiry.InquiryWorkscopes
                                .Where(x => x.IsActive == true && x.IsDeleted == false)
                                .Select(x => x.Workscope.WorkScopeName).ToList(),
                            InquiryCode = "IN" + inquiry.BranchId + "" + inquiry.CustomerId + "" + inquiry.InquiryId,
                            AmountPending = (decimal)inquiry.Payments.Where(x =>
                                x.PaymentStatusId == (int)paymentstatus.InstallmentPending ||
                                x.PaymentStatusId == (int)paymentstatus.PaymentPending).Sum(x => x.PaymentAmount) / 100,

                            reportPayments = inquiry.Payments
                                .Where(x => x.PaymentStatusId == (int)paymentstatus.InstallmentPending ||
                                            x.PaymentStatusId == (int)paymentstatus.PaymentPending).Select(x =>
                                    new reportPayment
                                    {
                    ...
                    if (inquiry.Payments
                            .Where(x => x.PaymentStatusId == (int)paymentstatus.InstallmentApproved ||
                        ...
                        100 > 0)
                    {
                        report.InquiryReceivedDetails.Add(new InquiryReceivedDetails
                        {
                            ...
                            WorkscopeName = inquiry.InquiryWorkscopes
                                ...
                                .Select(x => x.Workscope.WorkScopeName).ToList(),
                            InquiryCode = "IN" + inquiry.BranchId + "" + inquiry.CustomerId + "" + inquiry.InquiryId,
                            AmountRecieved = (decimal)inquiry.Payments.Where(x =>
                                                 x.PaymentStatusId == (int)paymentstatus.InstallmentApproved ||
                                                 x.PaymentStatusId == (int)paymentstatus.PaymentApproved)
                                             .Sum(x => x.PaymentAmount) /
                                             100,
                            reportPayments = inquiry.Payments
                                .Where(x => x.PaymentStatusId == (int)paymentstatus.InstallmentApproved ||
                                            x.PaymentStatusId == (int)paymentstatus.PaymentApproved).Select(x =>
                                    new reportPayment
                                    {
                                        Amount = (decimal)x.PaymentAmount / 100,
                ...
                IEnumerable<Models.Inquiry> inquiries = branch.Inquiries.Where(y =>
                    Helper.Helper.ConvertToDateTime(y.CreatedDate).Month >=
                    Helper.Helper.ConvertToDateTime(req.StartDate).Month &&
                    Helper.Helper.ConvertToDateTime(y.CreatedDate).Month <=
                    Helper.Helper.ConvertToDateTime(req.EndDate).Month);

                for (int i = Helper.Helper.ConvertToDateTime(req.StartDate).Month;
                    i <= Helper.Helper.ConvertToDateTime(req.EndDate).Month;
                    i++)
                {
                    List<ICollection<Models.InquiryWorkscope>> inworscopes = inquiries.Where(x => Helper.Helper.ConvertToDateTime(x.CreatedDate).Month == i)
                        .Select(x => x.InquiryWorkscopes).ToList();
                    List<ICollection<Models.Payment>> payments = inquiries.Where(x => Helper.Helper.ConvertToDateTime(x.CreatedDate).Month == i)
                        .Select(x => x.Payments).ToList();
                    ...
                    inworscopes.ForEach(x => FeedBackAverage = x.Select(y =>
                        y.FeedbackReaction == null ? 1 : y.FeedbackReaction == 0 ? 1 : y.FeedbackReaction).Average());
                    payments.ForEach(x =>
                        PaymentAverage = x.Select(y => y.PaymentAmount == null ? 0 : y.PaymentAmount).Average());
                ...
                foreach (Models.Customer Customer in branch.Customers.OrderBy(x => Helper.Helper.ConvertToDateTime(x.CreatedDate)))
                {
                    ...
                    foreach (Models.Inquiry inquiry in Customer.Inquiries)
                    {
                        foreach (Models.Payment payment in inquiry.Payments.Where(x =>
                            x.PaymentStatusId == (int)paymentstatus.InstallmentApproved ||
                            x.PaymentStatusId == (int)paymentstatus.PaymentApproved))
                        {
                    ...
                    x.IsActive == true && x.IsDeleted == false))
                {
                    ...
                    {
                        value = branch.Customers.Where(x =>
                                x.IsActive == true && x.IsDeleted == false &&
                                x.WayofContactId == wayofcontact.WayOfContactId).Count() /
                            (double)branch.Customers.Count() * 100;
                    }
                ...
                for (int i = 1; i < 5; i++)
                {
                    ...
                    {
                        foreach (Models.Inquiry inquiry in branch.Inquiries)
                        {
                            value += (decimal)inquiry.Payments.Where(x =>
                                    x.IsActive == true && x.IsDeleted == false && x.PaymentTypeId == i &&
                                    (x.PaymentStatusId == (int)paymentstatus.PaymentApproved ||
                                     x.PaymentStatusId == (int)paymentstatus.InstallmentApproved))
                                .Sum(x => x.PaymentAmount);
                        }
                ...
                foreach (Models.UserRole userrole in branch.UserRoles)
                {
