...
namespace SaiKitchenBackend.Controllers
{
    public class InquiryController : BaseController
    {
        ...
        public object GetCountByBranchId(int branchId)
        {
            ...
            var Numbers = branchRepository.FindByCondition(x => x.IsActive == true && x.IsDeleted == false).Select(x => new
            {
                inquiriesCount = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false).Count(),
                customers = x.Customers.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false).Count(),
                measurementAssinee = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && x.InquiryStatusId == (int)inquiryStatus.measurementAssigneePending && x.InquiryWorkscopes.Any(y => y.IsActive == true && y.IsDeleted == false && y.MeasurementAssignedTo == Constants.userId)).Count(),
                measurements = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.measurementInProgress || x.InquiryStatusId == (int)inquiryStatus.measurementRejected || x.InquiryStatusId == (int)inquiryStatus.measurementdelayed) && x.InquiryWorkscopes.Any(y => y.IsActive == true && y.IsDeleted == false && y.MeasurementAssignedTo == Constants.userId)).Count(),
                measurementApprovals = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.measurementWaitingForApproval && x.ManagedBy == Constants.userId)).Count(),
                ...
                designs = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.designPending || x.InquiryStatusId == (int)inquiryStatus.designDelayed || x.InquiryStatusId == (int)inquiryStatus.designRejected || x.InquiryStatusId == (int)inquiryStatus.designRevisionRequested) && x.InquiryWorkscopes.Any(y => y.IsActive == true && y.IsDeleted == false && y.DesignAssignedTo == Constants.userId)).Count(),
                designApprovals = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.designWaitingForApproval || x.InquiryStatusId == (int)inquiryStatus.designRejectedByCustomer) && x.ManagedBy == Constants.userId).Count(),
                quotationAssign = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.quotationSchedulePending) && x.InquiryWorkscopes.Any(y => y.IsActive == true && y.IsDeleted == false && y.DesignAssignedTo == Constants.userId)).Count(),
                quotations = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.quotationPending || x.InquiryStatusId == (int)inquiryStatus.quotationRejected || x.InquiryStatusId == (int)inquiryStatus.quotationDelayed || x.InquiryStatusId == (int)inquiryStatus.quotationRevisionRequested) && x.ManagedBy == Constants.userId).Count(),
                quotationApprovals = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && x.InquiryStatusId == (int)inquiryStatus.quotationWaitingForApproval && x.ManagedBy == Constants.userId).Count(),
                uploadcontract = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.contractInProgress || x.InquiryStatusId == (int)inquiryStatus.contractRejected) && x.ManagedBy == Constants.userId).Count(),
                technicalChecklist = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.checklistPending || x.InquiryStatusId == (int)inquiryStatus.commercialChecklistRejected) && x.ManagedBy == Constants.userId).Count(),
                commericalChecklist = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.commercialChecklistPending || x.InquiryStatusId == (int)inquiryStatus.jobOrderFactoryRejected || x.InquiryStatusId == (int)inquiryStatus.specialApprovalRejected) && x.ManagedBy == Constants.userId).Count(),
                specialApprovals = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.specialApprovalPending) && x.ManagedBy == Constants.userId).Count(),
                joborderAudit = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.jobOrderAuditPending) && x.ManagedBy == Constants.userId).Count(),
                joborderStatus = JoborderStatus,
                joborderApprovals = x.Inquiries.Where(x => x.BranchId == branchId && x.IsActive == true && x.IsDeleted == false && (x.InquiryStatusId == (int)inquiryStatus.jobOrderConfirmationPending || x.InquiryStatusId == (int)inquiryStatus.jobOrderAuditRejected)).Count(),
                users = userList,
                branches = Branches,
